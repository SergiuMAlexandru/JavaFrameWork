...
public class FabricaBMW extends FabricaMasina {
    ...
    public FabricaBMW(String model, String sasiu, String culoare, String motorizare, List<String> dotariExterioare, List<String> dotariInterioare) {
    ...
    public FabricaBMW(String model, String sasiu, String culoare, String motorizare) {
        super("BMW", model, sasiu, culoare, motorizare);
    }
    ...
    public void angajariFirma(){
        System.out.println("Fabrica BMW are 2 locuri disponibile pentru angajare");
        super.angajariFirma();
    }
}
